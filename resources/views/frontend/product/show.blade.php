                                            ...
                                            <div>
                                                <a href="{{ asset('documents/' . basename($document->file_path)) }}"
                                                    ...
                                                    @if (Str::endsWith($document->file_path, '.pdf'))
                                                        <img src="{{ asset('assets/icons/pdf-icon.png') }}" alt="PDF"
                                                            width="25">
                                                    @elseif (Str::endsWith($document->file_path, ['.exe', '.zip']))
                                                        <img src="{{ asset('assets/icons/software-icon.png') }}"
                                                            alt="Software" width="25">
                                                    @elseif (Str::endsWith($document->file_path, ['.dll', '.inf']))
                                                        <img src="{{ asset('assets/icons/driver-icon.png') }}"
                                                            alt="Driver" width="25">
                                                    @else
                                                        <img src="{{ asset('assets/icons/file-icon.png') }}" alt="File"
                                                            width="25">
                                                    @endif
