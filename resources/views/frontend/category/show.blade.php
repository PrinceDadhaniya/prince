                ...
                @if ($category)
                    ...
                    <ul class="nav nav-tabs mt-4" id="categoryTabs">
                        ...
                        @if (isset($products) && $products->count() > 0)
                            <li class="nav-item">
                                <button
                                    class="nav-link {{ isset($childCategories) && $childCategories->count() == 0 ? 'active' : '' }}"
                    ...
                    <div class="tab-pane fade {{ isset($childCategories) && $childCategories->count() == 0 ? 'show active' : '' }}" id="products-pane">
                        ...
                        @if ($category->products->count() > 0)
                            <div class="tab-pane fade {{ $childCategories->count() == 0 ? 'show active' : '' }}"
                                id="products-pane">
                                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 mt-3">
                                    @foreach ($category->products as $product)
                                        <div class="col">
                                            <div class="card">
                                                ...
                                                <div class="card-body d-flex flex-column">
                                                    <h5 class="card-title text-primary text-truncate">{{ $product->name }}
                                                    </h5>
                                                    <p class="card-text text-muted text-truncate">
