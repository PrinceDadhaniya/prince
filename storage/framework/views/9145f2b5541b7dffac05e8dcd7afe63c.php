                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.document-category.index')); ?>" data-bs-original-title="" title="">
                        ...
                        <li class="breadcrumb-item active">Document Category Edit</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.document-category.update', $category->id)); ?>" method="POST"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <?php if($category->image): ?>
                                    <img src="<?php echo e(asset('uploads/category/' . $category->image)); ?>" alt="Category Image" class="mt-3"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\prince-gpm11\prince-gpm\group-project-main\resources\views/admin/document-category/edit.blade.php ENDPATH**/ ?>