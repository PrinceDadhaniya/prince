                                            ...
                                            <div>
                                                <a href="<?php echo e(asset('documents/' . basename($document->file_path))); ?>"
                                                    ...
                                                    <?php if(Str::endsWith($document->file_path, '.pdf')): ?>
                                                        <img src="<?php echo e(asset('assets/icons/pdf-icon.png')); ?>" alt="PDF"
                                                            width="25">
                                                    <?php elseif(Str::endsWith($document->file_path, ['.exe', '.zip'])): ?>
                                                        <img src="<?php echo e(asset('assets/icons/software-icon.png')); ?>"
                                                            alt="Software" width="25">
                                                    <?php elseif(Str::endsWith($document->file_path, ['.dll', '.inf'])): ?>
                                                        <img src="<?php echo e(asset('assets/icons/driver-icon.png')); ?>"
                                                            alt="Driver" width="25">
                                                    <?php else: ?>
                                                        <img src="<?php echo e(asset('assets/icons/file-icon.png')); ?>" alt="File"
                                                            width="25">
                                                    <?php endif; ?>
            ...
            function filterDocuments() {
                ...
                $('#documentList .document-item').each(function() {
                    ...
                    let categoryMatch = selectedCategories.length === 0 || selectedCategories.includes(
                        category);
                    let languageMatch = selectedLanguages.length === 0 || selectedLanguages.includes(
                        language);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\New Project\prince (3) (1)\prince\resources\views/frontend/product/show.blade.php ENDPATH**/ ?>