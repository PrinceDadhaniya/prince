        ...
        <div class="card">
            <div class="card-header">
                <h3>Create Document Category
                    <a href="<?php echo e(route('admin.document-category.index')); ?>" class="btn btn-danger btn-sm text-white float-end">Back</a>
                </h3>
            </div>
            <div class="card-body">
                <form id="createCategoryForm" action="<?php echo e(route('admin.document-category.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <!-- Name -->
                    <div class="mb-3 row">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\prince-gpm15\prince-gpm11\prince-gpm\group-project-main\resources\views/admin/document-category/create.blade.php ENDPATH**/ ?>