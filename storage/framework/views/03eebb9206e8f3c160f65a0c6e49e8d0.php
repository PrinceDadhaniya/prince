                        ...
                        <?php if(isset($product) && $product->documents->count() > 0): ?>
                            <?php $__currentLoopData = $product->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="document mb-3" id="document-<?php echo e($index); ?>">
                                    ...
                                    <input type="file" name="documents[<?php echo e($index); ?>][file_path]"
                                        class="form-control">
                        ...
                        <?php else: ?>
                            <div class="document mb-3" id="document-0">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <?php if(isset($document->file_path) && $document->file_path): ?>
                                        <div class="mt-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\New Project\prince (3) (1)\prince\resources\views/admin/product/create.blade.php ENDPATH**/ ?>