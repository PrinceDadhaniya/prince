                        ...
                        <a href="<?php echo e(route('newsview', $article->id)); ?>" class="card-link">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-truncate"><?php echo e(Str::limit($article->description, 150, '...')); ?></p> <!-- Adjusted limit to 150 characters -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ITP\Downloads\prince (3) (1)\prince\resources\views/frontend/news/index.blade.php ENDPATH**/ ?>