                            ...
                            <a href="<?php echo e(route('newsview', $article->id)); ?>" class="card-link">
                                <div class="card h-100">
                                    <a href="<?php echo e(route('newsview', $article->id)); ?>">
                                        <img src="<?php echo e(asset($article->image)); ?>" class="card-img-top fixed-image"
                                            alt="<?php echo e($article->header); ?>">
                                    </a>
                                    <div class="card-body">
                                        <h3 class="card-title text-truncate"><?php echo e($article->header); ?></h3>
                                        <p class="card-text text-truncate">
                                            <?php echo e(Str::limit($article->description, 150, '...')); ?></p>
                                        <!-- Adjusted limit to 150 characters -->
                                        <a href="<?php echo e(route('newsview', $article->id)); ?>" class="btn btn-primary">Read
                                            More</a>
                                    </div>
                                </div>
                            </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\New Project\prince (3) (1)\prince\resources\views/frontend/news/index.blade.php ENDPATH**/ ?>