            ...
            <div class="col-md-3 mt-3">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php if(isset($childCategories) && $childCategories->count() > 0): ?>
                                ...
                                <?php $__currentLoopData = $childCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="mb-2">
                                        <input type="checkbox" class="form-check-input me-2 filter-checkbox"
                                            name="category[]" id="cat-<?php echo e($subcategory->id); ?>" value="<?php echo e($subcategory->id); ?>"
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <?php $__currentLoopData = $relatedBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($brand): ?>
                                <div class="mb-2">
                                    <input type="checkbox" class="form-check-input me-2 filter-checkbox" name="brand[]"
                                        id="brand-<?php echo e($brand->id); ?>" value="<?php echo e($brand->id); ?>"
                ...
                <?php if($category): ?>
                    <p class="product-path text-muted mt-3 ms-3">
                        ...
                        <?php $__currentLoopData = $breadcrumb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            > <a href="<?php echo e(url('/category', $crumb->id)); ?>"><?php echo e($crumb->name); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex mt-3">
                                <a href="#" class="btn text-white"
                                    style="background-color: #2561a8; padding:5px 30px;"><b>Contact Sales</b></a>
                                <a href="#" class="btn"
                    ...
                    <ul class="nav nav-tabs mt-4" id="categoryTabs">
                        <?php if(isset($childCategories) && $childCategories->count() > 0): ?>
                            <li class="nav-item">
                                <button class="nav-link active" id="subcategories-tab" data-bs-toggle="tab"
                                    data-bs-target="#subcategories-pane" type="button">Subcategories</button>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if(isset($products) && $products->count() > 0): ?>
                            <li class="nav-item">
                                <button
                                    class="nav-link <?php echo e(isset($childCategories) && $childCategories->count() == 0 ? 'active' : ''); ?>"
                                    id="products-tab" data-bs-toggle="tab" data-bs-target="#products-pane"
                    ...
                    <div class="tab-content">
                                        ...
                                        <?php $__currentLoopData = $childCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col">
                                                <div class="card h-100 shadow-sm d-flex flex-column">
                                                    <img src="<?php echo e(asset('uploads/category/' . $subcategory->image)); ?>"
                                                        alt="<?php echo e($subcategory->name); ?>" class="card-img-top"
                                                        style="object-fit: cover; height: 200px;">
                                                    <div class="card-body d-flex flex-column">
                                                        <h5 class="card-title text-primary text-truncate">
                                                            <?php echo e($subcategory->name); ?></h5>
                                                        <p class="card-text text-muted text-truncate">
                                                            <?php echo e($subcategory->description); ?></p>
                                                        <div class="mt-auto">
                                                            <a href="<?php echo e(url('/category', $subcategory->id)); ?>"
                        ...
                        <?php if($category->products->count() > 0): ?>
                            <div class="tab-pane fade <?php echo e($childCategories->count() == 0 ? 'show active' : ''); ?>"
                                id="products-pane">
                                    ...
                                    <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col">
                                            <div class="card">
                                                ...
                                                <div class="card-body d-flex flex-column">
                                                    <h5 class="card-title text-primary text-truncate"><?php echo e($product->name); ?>

                                                    </h5>
                                                    <p class="card-text text-muted text-truncate">
                                                        <?php echo e($product->serial_number); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\New Project\prince (3) (1)\prince\resources\views/frontend/category/show.blade.php ENDPATH**/ ?>