    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchDocumentBrands() {
                $.ajax({
                    url: "<?php echo e(route('fetch.document.brands')); ?>", // Ensure this route matches the backend
                    method: "GET",
                    success: function(response) {
