                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.document-categories.index')); ?>">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Edit Document Category
                        <a href="<?php echo e(route('admin.document-categories.index')); ?>" class="btn btn-danger btn-sm text-white float-end">Back</a>
                    </h3>
                </div>
                <div class="card-body">
                    <form id="update-form" action="<?php echo e(route('admin.document-categories.update', $category->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="parent_id">
                                    ...
                                    <?php $__currentLoopData = $parentCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parentCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($parentCategory->id); ?>" <?php echo e($category->parent_id == $parentCategory->id ? 'selected' : ''); ?>><?php echo e($parentCategory->name); ?></option>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <?php if($category->image): ?>
                                    <img src="<?php echo e(asset('uploads/category/' . $category->image)); ?>" alt="Category Image" class="mt-3" style="width: 100px; height: 100px;">
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\prince-gpm15\prince-gpm11\prince-gpm\group-project-main\resources\views/admin/document-category/edit.blade.php ENDPATH**/ ?>