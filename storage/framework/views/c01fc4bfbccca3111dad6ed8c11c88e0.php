    ...
    <div class="container mt-5">
        ...
        <form action="<?php echo e(route('admin.documents-sections.update', $document->id)); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="category_id" class="form-control" id="category_id" value="<?php echo e($document->category_id); ?>" required>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\prince-gpm11\prince-gpm\group-project-main\resources\views/admin/documents-sections/edit.blade.php ENDPATH**/ ?>