            ...
            <?php if($category): ?>
                ...
                <ul class="nav nav-tabs mt-4" id="categoryTabs">
                    ...
                    <?php if(isset($products) && $products->count() > 0): ?>
                        <li class="nav-item">
                            <button class="nav-link <?php echo e(isset($childCategories) && $childCategories->count() == 0 ? 'active' : ''); ?>" id="products-tab" data-bs-toggle="tab" data-bs-target="#products-pane" type="button">Products</button>
                        </li>
                    <?php endif; ?>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <!-- Products Tab -->
                    <?php if(isset($products) && $products->count() > 0): ?>
                    <div class="tab-pane fade <?php echo e(isset($childCategories) && $childCategories->count() == 0 ? 'show active' : ''); ?>" id="products-pane">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ITP\Downloads\prince (3) (1)\prince\resources\views/frontend/category/show.blade.php ENDPATH**/ ?>