            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.categories.update', $category->id)); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="slug" value="<?php echo e(old('slug', $category->slug)); ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="serial_number" value="<?php echo e(old('serial_number', $category->serial_number)); ?>">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="parent_id">
                                ...
                                <?php $__currentLoopData = $parentCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parentCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($parentCategory->id); ?>" <?php echo e($parentCategory->id == old('parent_id', $category->parent_id) ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\New Project\prince (3) (1)\prince\resources\views/admin/category/edit.blade.php ENDPATH**/ ?>